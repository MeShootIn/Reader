                     ...
                     int nCmdShow)
{
    ...
    //wincl.hbrBackground = CreateSolidBrush(RGB(255, 255, 255)); // Белый фон
...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch(message){
        ...
        case WM_SIZE:{
            ...
            /*
            Если режим с вёрсткой, то при изменении размеров окна
            нужно переинициализировать структуру текста
            */
        ...
        case WM_KEYDOWN:{
            ...
            switch(wParam){
                ...
                case VK_RIGHT:{
                    ...
                    // Достигнут последний (пустой) символ строки
                    else{
                        if(ws.linePos + ws.vCaretPos < ts.lines - 1){
